...
DEFAULT_ELITE_SEEDS: list[dict[str, str]] = [
    ...
    {"id": "elite_10", "address": "6KR7SorsUQtNH6CB6JpAnWCAKeTysa95iyXeWihdNeGT", "label": "Korean", "tier": "S", "style": "kol_moon", "note": "Korean — user-tracked top trader; buy = elite signal"},
    {"id": "elite_11", "address": "BQVz7fQ1WsQmSTMY3umdPEPPTm1sdcBcX9sP7o6kPRmB", "label": "Limfork", "tier": "S", "style": "kol_moon", "note": "Limfork — user-tracked top trader; buy = elite signal"},
    {"id": "elite_12", "address": "FAicXNV5FVqtfbpn4Zccs71XcfGeyxBSGbqLDyDJZjke", "label": "Radiance", "tier": "S", "style": "kol_moon", "note": "Radiance — user-tracked top trader; buy = elite signal"},
